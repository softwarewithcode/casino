...
public class BaseTest {
	...
	protected static final BlackjackData blackjackInitData = new BlackjackData(MIN_BUYIN, MIN_BET, MAX_BET, BET_ROUND_TIME_SECONDS, INSURANCE_ROUND_TIME_SECONDS, PLAYER_TIME_SECONDS, DEFAULT_ALLOWED_SIT_OUT_ROUNDS,
	...
	protected TableData getDefaultSinglePlayerTableInitData() {
		return new TableData(BlackjackPhasePathFactory.buildBlackjackPath(), TableStatus.WAITING_PLAYERS, getDefaultThresholds(), UUID.randomUUID(), Language.ENGLISH, TableType.SINGLEPLAYER, Game.BLACKJACK);
	}
...
//	}
	...
	protected BlackjackData createBlackjackInitData(BigDecimal minimumBuyIn, BigDecimal minimumBet, BigDecimal maximumBet, Integer betPhaseTime, Integer insurancePhaseTime, Integer playerTime, Integer skips, Long newRoundDelay) {
