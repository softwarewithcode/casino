...
public class BlackjackTableService {
	...
	private static final Integer BET_PHASE_TIME_SECONDS = 15;
	private static final Integer INSURANCE_PHASE_TIME_SECONDS = 11;
	private static final Integer PLAYER_TIME_SECONDS = 30;
	private static final long DELAY_BEFORE_STARTING_NEW_BET_PHASE_MILLIS = 10000l;
	...
	public BlackjackTableService() {
		...
		BlackjackTable table = new BlackjackTable(Status.WAITING_PLAYERS,
				new Thresholds(MIN_BET, MAX_BET, BET_PHASE_TIME_SECONDS, INSURANCE_PHASE_TIME_SECONDS, PLAYER_TIME_SECONDS, DELAY_BEFORE_STARTING_NEW_BET_PHASE_MILLIS, MIN_PLAYERS, MAX_PLAYERS, DEFAULT_SEAT_COUNT, Type.PUBLIC),
