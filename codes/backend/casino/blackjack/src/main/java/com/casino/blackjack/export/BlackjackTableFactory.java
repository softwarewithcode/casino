...
public class BlackjackTableFactory {
	...
	public static BlackjackTableAPI createDefaultMultiplayerTable() {
		...
		BlackjackData blackjackInitData = createBlackjackInitData(new BigDecimal("5.0"), new BigDecimal("5.0"), new BigDecimal("10.0"), 10, 10, 10, 2, 5000l);
		BlackjackTable temp1 = new BlackjackTable(tableInitData, blackjackInitData);
		return temp1;
	}

	public static BlackjackTableAPI createDefaultSinglePlayerTable() {
		TableData tableInitData = createTableInitData(MIN_PLAYER_DEFAULT, MAX_PLAYERS_DEFAULT, SEAT_COUNT_DEFAULT, TableType.MULTIPLAYER);
		BlackjackData blackjackInitData = createBlackjackInitData(new BigDecimal("5.0"), new BigDecimal("5.0"), new BigDecimal("10.0"), 10, 10, 10, 2, 5000l);
		BlackjackTable temp1 = new BlackjackTable(tableInitData, blackjackInitData);
		return temp1;
	...
	public static BlackjackTableAPI createMultiPlayerTable(Integer minPlayers, Integer maxPlayers, BigDecimal minimumBuyIn, BigDecimal minimumBet, BigDecimal maximumBet, Integer betPhaseTime, Integer insurancePhaseTime, Integer playerTime,
		...
		BlackjackData blackjackInitData = createBlackjackInitData(minimumBuyIn, minimumBet, maximumBet, betPhaseTime, insurancePhaseTime, playerTime, skips, newRoundDelay);
		return new BlackjackTable(tableInitData, blackjackInitData);
	}

	private static BlackjackData createBlackjackInitData(BigDecimal minimumBuyIn, BigDecimal minimumBet, BigDecimal maximumBet, Integer betPhaseTime, Integer insurancePhaseTime, Integer playerTime, Integer skips, Long newRoundDelay) {
		return new BlackjackData(minimumBuyIn, minimumBet, maximumBet, betPhaseTime, insurancePhaseTime, playerTime, skips, newRoundDelay);
	}
