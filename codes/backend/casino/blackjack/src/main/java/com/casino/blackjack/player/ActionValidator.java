...
public class ActionValidator {
	...
	public static void validateInsureAction(BlackjackPlayer player) {
		...
		BigDecimal insuranceAmount = player.getFirstHand().getBet().divide(TWO);
	...
	public static void validateBalance(BigDecimal requiredBalance, BlackjackPlayer player) {
		try {
			BetVerifier.verifySufficentBalance(requiredBalance, player);
		} catch (Exception e) {
